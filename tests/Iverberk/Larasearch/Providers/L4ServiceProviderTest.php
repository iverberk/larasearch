...
/**
 * Class L4ServiceProviderTest
 */
class L4ServiceProviderTest extends \PHPUnit_Framework_TestCase {
    ...
    public function it_should_boot()
    {
         ...
         * Set
         */
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[package, bootContainerBindings]', ['something']);
    ...
    public function it_should_boot_container_bindings()
    {
         ...
         * Set
         */
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[' .
    ...
    public function it_should_bind_elasticsearch()
    {
        ...
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindElasticsearch]', [$app]);
	...
	public function it_should_bind_logger()
	{
		 ...
		 */
		$app = m::mock('LaravelApp');
		$sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindLogger]', [$app]);
    ...
    public function it_should_bind_index()
    {
        ...
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindIndex]', [$app]);
    ...
    public function it_should_bind_query()
    {
        ...
        $app = m::mock('LaravelApp');
        $proxy = m::mock('Iverberk\Larasearch\Proxy', [$model]);
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindQuery]', [$app]);
    ...
    public function it_should_bind_proxy()
    {
        ...
        $model->shouldReceive('getTable')
            ...
            ->andReturn('mockType');
        $app = m::mock('LaravelApp');
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindProxy]', [$app]);
	...
	public function it_should_bind_result()
	{
		 ...
		 */
		$app = m::mock('LaravelApp');
		$sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[bindResult]', [$app]);
    ...
    public function it_should_register_commands()
    {
        ...
        $sp = m::mock('Iverberk\Larasearch\Providers\L4ServiceProvider[registerCommands, commands]', [$app]);
    ...
    public function it_should_provide_services()
    {
         ...
         * Assertion
         */
        $sp = new Iverberk\Larasearch\Providers\L4ServiceProvider($app);
